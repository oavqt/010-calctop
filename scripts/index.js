...
function cChalkboard() {
  ...
  footer.className = 'container__calculator__display__chalkboard__footer';
...
function cChalkboardFooter() {
  const footer = document.querySelector(
    '.container__calculator__display__chalkboard__footer'
  );
  const eraser = document.createElement('button');
  const clear = document.createElement('button');
  eraser.classList =
    'container__calculator__display__chalkboard__footer__eraser';
  clear.className = 'container__calculator__display__chalkboard__footer__clear';
